...
const PQRCompo: React.FC<IProps> = ({ empresa }) => {
    ...
    const { formData, updateForm, validateForm, errors } = useForm({
        ...
        validations: {
            ...
            phone: (value) => string(value).required().numeric().length(10).validate(),
    ...
    return (
        <>
            <div className="pqr-success">
                {showAlert && (<Alert className="alert-sucess" variant="default">
                    <AlertCircle className="h-0 w-4" />
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                        aria-hidden="true" className="icon-success h-5 w-14 oc se axw">
                        <path stroke-linecap="round" className="icon-color" stroke-linejoin="round"
                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm content-all-fields">
                    <form noValidate onSubmit={handleSubmit}>
                        <div className="content-fields pqr">
                            <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900 text-login">PQR</h2>
                        </div>
                        <p className="mt-6 text-base leading-7 text-gray-500 small-text">Estas a punto de llenar una pqr para la empresa {empresa}</p>
                        <div className="content-fields">
                            <div className="flex items-center justify-between">
                                <label className="block text-sm font-medium leading-6 text-gray-900">Name</label>
                            </div>
                            <div className="mt-2">
                                <input onChange={(e) => updateForm({ name: e.target.value })} value={formData.name} placeholder="Name" id="name" name="name" type="text" required className="block w-full rounded-md border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-5| focus:ring-inset sm:text-sm sm:leading-6 field" />
                        ...
                        <div className="content-fields">
                            ...
                            <div className="mt-2">
                                <input onChange={(e) => updateForm({ lastName: e.target.value })} value={formData.lastName} placeholder="Last Name" id="LastName" name="LastName" type="text" required className="block w-full rounded-md border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-5 focus:ring-inset sm:text-sm sm:leading-6 field" />
                                {errors?.lastName && (<Alert variant="destructive">
                                    <AlertCircle className="h-4 w-4" />
                                    <AlertDescription>
                        ...
                        <div className="content-fields">
                            ...
                            <div className="mt-2">
                                <input onChange={(e) => updateForm({ phone: e.target.value })} value={formData.phone} placeholder="Phone" id="Phone" name="Phone" type="tel" required className="block w-full rounded-md border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-5 focus:ring-inset sm:text-sm sm:leading-6 field" />
                                {errors?.phone && (<Alert variant="destructive">
                                    <AlertCircle className="h-4 w-4" />
                                    <AlertDescription>
                        ...
                        <div className="content-fields">
                            ...
                            <div className="mt-2">
                                <input onChange={(e) => updateForm({ email: e.target.value })} value={formData.email} placeholder="Email" id="Email" name="Email" type="email" required className="block w-full rounded-md border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-5 focus:ring-inset sm:text-sm sm:leading-6 field" />
                        ...
                        <div className="content-fields">
                            ...
                            <div className="mt-2">
                                <input onChange={(e) => updateForm({ subject: e.target.value })} value={formData.subject} placeholder="Subject" id="subject" name="subjet" type="text" required className="block w-full rounded-md border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-5 focus:ring-inset sm:text-sm sm:leading-6 field" />
                                {errors?.subject && (<Alert variant="destructive">
                                    <AlertCircle className="h-4 w-4" />
                                    <AlertDescription>
                        ...
                        <div className="content-fields">
                            ...
                            <div className="lb">
                                <textarea onChange={(e) => updateForm({ message: e.target.value })} value={formData.message} placeholder="Describe..." name="comment" id="comment" rows={4} className="sm:text-sm field w-full ring-1 ring-inset ring-gray-300"></textarea>
                                {errors?.message && (<Alert variant="destructive">
                                    <AlertCircle className="h-4 w-4" />
                                    <AlertDescription>
                        ...
                        <div className="content-fields">
                            <button onClick={() => { !validateForm(); }} type="submit" id="btn-enviar" className="btn-enviar ">Enviar PQR</button>
                        </div>
                    </form>
                </div>
                <div />
